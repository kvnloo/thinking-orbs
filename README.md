...
<ThinkingOrb state="cosmic" />     {/* galaxy core with star dust */}
<ThinkingOrb state="nebula" />     {/* atmospheric glow */}
<ThinkingOrb state="liquid" />     {/* fluid glass bubble */}
<ThinkingOrb state="nova" />       {/* amber flare, prismatic rim */}
```
